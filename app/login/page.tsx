...
export default function LoginPage() {
  ...
  const handleGuestLogin = () => {
    clearError();
    const success = loginAsGuest('ゲスト');
    if (success) {
      router.push('/home');
    }
  };
      ...
      <div className="bg-white p-8 rounded-lg shadow-xl w-96">
        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          <button
            ...
            disabled={loading}
            className="w-full bg-green-500 text-white py-2 px-4 rounded-md hover:bg-green-600 disabled:bg-gray-400 disabled:cursor-not-allowed transition"
          >
            🎮 ゲストとしてプレイ
          </button>
        </div>
